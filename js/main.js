;(function () {
	...
	'use strict';
	var li1 = 20;
	document.getElementById("like1").innerText = li1;
	document.getElementById("heart1").addEventListener('click',() => {
    li1++;
    document.getElementById("like1").innerText = li1;
});
var li2 = 20;
	document.getElementById("like2").innerText = li2;
	document.getElementById("heart2").addEventListener('click',() => {
    li2++;
    document.getElementById("like2").innerText = li2;
});
var li3 = 20;
	document.getElementById("like3").innerText = li3;
	document.getElementById("heart3").addEventListener('click',() => {
    li3++;
    document.getElementById("like3").innerText = li3;
});
var li4 = 20;
	document.getElementById("like4").innerText = li4;
